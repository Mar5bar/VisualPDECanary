...
\begin{aligned}
      \pd{a}{t} &= D \lap a + a \left(1-\rho-r \left[b+d\right]+s \left[c+e\right]\right),\\
      \pd{b}{t} &= D \lap b + b \left(1-\rho-r \left[c+e\right]+s \left[d+a\right]\right),\\
      \pd{c}{t} &= D \lap c + c \left(1-\rho-r \left[d+a\right]+s \left[e+b\right]\right),\\
      \pd{d}{t} &= D \lap d + d \left(1-\rho-r \left[e+b\right]+s \left[a+c\right]\right),\\
      \pd{e}{t} &= D \lap e + e \left(1-\rho-r \left[a+c\right]+s \left[b+d\right]\right),\\
     \rho &= a+b+c+d+e,
\end{aligned}
