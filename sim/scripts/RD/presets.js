...
export function getPreset(id) {
  ...
  switch (id) {
	...
	"cameraPhi": 0,
	"cameraTheta": 0,
	"clearValueU": "a*(1+0.05*cos(x*pi/L_x))",
	"clearValueV": "b/a",
	"colourbar": true,
	"crossDiffusion": true,
	"diffusionStrUU": "e",
	...
	"domainScale": "0.5",
	"dt": 0.00005,
	"kineticParams": "D_v = 8 in [7, 0.1, 9];a = 5;b = 9;e = 0.004",
	"maxColourValue": 30,
	"minColourValue": -10,
	"numSpecies": "4",
	"plotType": "line",
	...
	"reactionStrU": "w",
	"reactionStrV": "q",
	"reactionStrW": "a+u^2*v-(b+1)*u",
	"reactionStrQ": "b*u-u^2*v",
	"spatialStep": "0.01",
	"timeDisplay": true,
	"typeOfBrush": "vline",
	"whatToDraw": "u",
...
break;
	...
	"dt": 0.0001,
	"emboss": true,
	"kineticParams": "D_v = 8 in [7, 0.1, 9];a = 5;b = 9;e = 0.01",
	"maxColourValue": 40,
	"minColourValue": -15,
	"numSpecies": "4",
