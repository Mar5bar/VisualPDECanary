...
presets["KymographLinearGrowth"] = {
	...
	"kineticParams": "a = 0.05 in [0, 0.1];b = 0.06 in [0.04, 0.1];T = 5000;L_0 = 30;r = 0.001;",
	"minX": "-L_x/2",
	"numSpecies": 3,
	"numTimestepsPerFrame": 200,
	...
	"overlayEpsilon": 0.01,
	"overlayExpr": "ind(y-t*L_y/T<dy)*ind((L_0+((y-L_0*dy)/(2*L_y))*(L_x-L_0))^2-x^2>0 )",
	"plotType": "plane",
	"whatToPlot": "m",
	"name": "Kymograph",
}],
...
presets["KymographExponentialGrowth"] = {
	...
	"kineticParams": "a = 0.05 in [0, 0.1];b = 0.06 in [0.04, 0.1];T = 2000;L_0 = exp(-r*T);r = 0.0015;",
	"numTimestepsPerFrame": 200,
	...
	"overlayColour": 16777215,
	"overlayEpsilon": 0.01,
	"overlayExpr": "ind(y-t*L_y/T<dy)*ind((L_x*exp(r*T*(y/(L_y)-1))/2)^2-(x)^2>0)",
	"plotType": "plane",
	"whatToPlot": "m",
	"name": "Kymograph",
}],
