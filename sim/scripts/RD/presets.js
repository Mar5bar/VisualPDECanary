  ...
  switch (id) {
    ...
    case "FitzHugh-Nagumo-3":
      options = {
        ...
        dt: 0.001,
        fixRandSeed: true,
        kineticParams: "a_v=.065 in [0, 0.2];m=4;e_v=0.2;e_w=1;a_w=0.5;a_z=-0.1;",
        minColourValue: -1,
        numSpecies: "3",
    ...
    case "swiftHohenberg":
      options = {
        ...
        diffusionStrWW: "0",
        dt: 0.0005,
        kineticParams: "r=0.1 in [-2,0.1,2];a=1 in [-2,0.1,2];b=1 in [-2,0.1,2];c=-1;D=1;",
    ...
    case "swiftHohenbergLocalised":
      options = {
        ...
        domainScale: 150,
        dt: 0.0005,
        kineticParams: "r=-0.28 in [-2,2];a=1.6 in [-2,2];b=-1 in [-2,0.1,2];c=-1;D=1;",
