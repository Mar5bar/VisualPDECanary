...
presets["NavierStokes"] = {
  ...
  kineticParams:
    "Re = 20.000 in [0.05, 100];epsilon_1 = 0.1;epsilon_2 = 0.04;D = 0.02;",
  numSpecies: 4,
...
presets["NavierStokesVorticityBounded"] = {
	...
	"brushAction": "replace",
	"brushValue": "0.2",
	"comboStr_1": "Bottom: Periodic; Left: Dirichlet = 0; Right: Dirichlet = 0; Top: Periodic;",
	"comboStr_3": "Bottom: Periodic; Left: Neumann = 0; Right: Neumann = 0; Top: Periodic;",
	"diffusionStr_1_1": "nu",
	"initCond_1": "A*cos(k*pi*x/L_x)*cos(k*pi*y/L_x)",
	"kineticParams": "nu = 0.05 in [0.01, 1];epsilon = 0.05;D = 0.1;k = 51.0 in [1, 1, 100];A = (0.005*k^1.5);",
	"numSpecies": 3,
...
presets["NavierStokesVorticity"] = {
	...
	"brushRadius": "10",
	"brushValue": "0.02",
	"comboStr_3": "Bottom: Periodic; Left: Dirichlet = 1; Right: Dirichlet = 0; Top: Periodic;",
	"diffusionStr_1_1": "nu",
	"diffusionStr_2_2": "1",
	"diffusionStr_3_3": "D",
	"domainScale": "500",
	...
	"kineticParams": "nu = 0.05 in [0.01, 1];epsilon = 0.05;D = 0.02;",
	"numSpecies": 3,
	"numTimestepsPerFrame": 200,
