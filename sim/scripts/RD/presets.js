...
presets["Conway"] = {
	...
	"probeLength": 3000,
	"reactionStr_1": "0",
	"reactionStr_2": "ind(v==0 && (ind(v[x+dx,y+dy]>0) + ind(v[x-dx,y+dy]>0) + ind(v[x,y+dy]>0) + ind(v[x,y-dy]>0) + ind(v[x-dx,y]>0) + ind(v[x-dx,y-dy]>0) + ind(v[x+dx,y-dy]>0) + ind(v[x+dx,y]>0))>2.5 && (ind(v[x+dx,y+dy]>0) + ind(v[x-dx,y+dy]>0) + ind(v[x,y+dy]>0) + ind(v[x,y-dy]>0) + ind(v[x-dx,y]>0) + ind(v[x-dx,y-dy]>0) + ind(v[x+dx,y-dy]>0) + ind(v[x+dx,y]>0))<3.5) + ind(v>0 && (ind(v[x+dx,y+dy]>0) + ind(v[x-dx,y+dy]>0) + ind(v[x,y+dy]>0) + ind(v[x,y-dy]>0) + ind(v[x-dx,y]>0) + ind(v[x-dx,y-dy]>0) + ind(v[x+dx,y-dy]>0) + ind(v[x+dx,y]>0))>1.5 && (ind(v[x+dx,y+dy]>0) + ind(v[x-dx,y+dy]>0) + ind(v[x,y+dy]>0) + ind(v[x,y-dy]>0) + ind(v[x-dx,y]>0) + ind(v[x-dx,y-dy]>0) + ind(v[x+dx,y-dy]>0) + ind(v[x+dx,y]>0))<3.5)",
	"reactionStr_3": "0",
	"spatialStep": "1",
	"typesetCustomEqs": false,
