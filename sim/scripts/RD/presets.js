...
presets["NoisyFHN"] = {
	...
	"brushType": "vline",
	"brushValue": "p",
	"comboStr_1": "Bottom: Dirichlet = 1+sin(t/100); Left: Dirichlet = 0.5*(1+sin(t/40)); Right: Neumann = 0; Top: Dirichlet = 1+sin(t/100);",
	"diffusionStr_1_1": "1",
	"diffusionStr_2_2": "0",
	"diffusionStr_3_3": "0",
	"dimension": "1",
	...
	"dt": 0.01,
	"initCond_1": "0",
	"kineticParams": "alpha = 0.37;beta = 0.131;gamma = 0.01;p = 0.005 in [0, 0.01];w = 14;sigma = 0.00000000000000000000 in [0, 0.4];",
	"minColourValue": "-1",
	...
	"probeFun": "u_1",
	"probeLength": 30,
	"reactionStr_1": "u_1*(1-u_1)*(u_1-beta)-u_2+sigma*WhiteNoise*u_1",
...
presets["NavierStokesVorticity"] = {
  ...
  brushValue: "0.02",
  comboStr_3:
    "Bottom: Periodic; Left: Dirichlet = 1; Right: Dirichlet = 0; Top: Periodic;",
  diffusionStr_1_1: "1/Re",
  diffusionStr_2_2: "1",
  diffusionStr_3_3: "D",
  domainScale: "500",
  ...
  kineticParams: "Re = 100 in [1, 100];epsilon = 0.05;D = 0.02;",
  numSpecies: "3",
  numTimestepsPerFrame: 200,
