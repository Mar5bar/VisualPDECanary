...
export function getListOfPresets() {
  ...
  listOfPresets["differentialStiffness"] = {
    ...
    brushEnabled: false,
    colourmap: "blue",
    comboStr_1: "Left: Dirichlet = 0; Left: Neumann = 0.2*sin(t)",
    ...
    dt: 0.0001,
    initCond_1: "0",
    kineticParams: "D = 0.0001;E_R = 12 in [0, 12];",
    ...
    spatialStep: "0.04",
    timescales: true,
    timescale_2: "((1+tanh(v/0.1))*E_R+1)^(-1)",
  ...
  listOfPresets["GrayScottPearsonClassificationRescaled"] = {
    ...
    reactionStr_1:
      "u^2*v - (0.001+0.069*(y/L_y)^(s)+0.01+0.057*(x/L_x)^(1/s))*u",
