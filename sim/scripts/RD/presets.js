...
presets["floodingOxford"] = {
  ...
  kineticParams:
    "F_max = 20;r = 0.01 in [0.01, 0.01, 2];a = 0.001 in [0.001,2];",
  numTimestepsPerFrame: 148,
  numSpecies: "4",
  parent: "WaterOnTopography",
  reactionStr_1: "r*ind(s>0) - a*h",
  ...
  views: [
    ...
    {
      cameraTheta: 89.99994136246796,
      cameraPhi: 0.2934453781513183,
      cameraZoom: 1,
      colourmap: "viridis",
      colourbar: false,
      customSurface: true,
      ...
      minColourValue: "-1",
      whatToPlot: "ind(h>0.5)*6.8 + ind(h<0.5)*(T-5)*1",
