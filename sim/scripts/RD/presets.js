...
presets["1DShallowWaterEqns"] = {
	...
	"dimension": "1",
	"domainScale": "1000",
	"initCond_1": "0.7*(0.2*1/cosh(0.05*(x-L_x/3))^2+0.05*1/cosh(0.075*(x-2*L_x/3))^2)",
...
presets["1DLinearizedShallowWaterEqns"] = {
	...
	"dimension": "1",
	"domainScale": "1000",
	"initCond_1": "0.7*(0.2*1/cosh(0.05*(x-L_x/3))^2+0.05*1/cosh(0.05*(x-2*L_x/3))^2)",
...
presets["ShallowWaterEqnsVorticalSolitons"] = {
	"brushValue": "0.2",
	"kineticParams": "H_e = 1;g = 9.81;f = 1;k = 0.001;nu = 0.5;epsilon = 0.0001;",
	"parent": "ShallowWaterEqns",
	"plotType": "surface",
	"surfaceFun": "h*1000",
	"views": [{
...
presets["ShallowWaterEqns"] = {
  ...
  reactionStr_2: "-g*h_x - k*u-u*u_x+f*v",
  reactionStr_3: "-g*h_y - k*v-v*v_x-f*u",
  spatialStep: "2",
...
presets["ducksSource"] = {
  ...
  parent: "ducks",
  preset: "ducksSource",
  reactionStr_1: "-(u*d_x +v*d_y) - d*(u_x + v_y) - 0.1*ind(I_SA>0)*d + s",
  whatToDraw: "s",
};
