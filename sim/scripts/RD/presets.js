...
export function getListOfPresets() {
  ...
  listOfPresets["TuringWaveFHN"] = {
    ...
    cameraPhi: 0,
    cameraTheta: 0,
    clearValueU: "0.816682 + 0.05*RAND",
    clearValueV: "4.35762",
    colourbar: true,
    colourmap: "lavaflow",
    crossDiffusion: true,
    diffusionStrUU: "delta",
    diffusionStrVV: "delta",
    diffusionStrWU: "d11/tau",
    diffusionStrWV: "d12/tau",
    diffusionStrWW: "D2",
    diffusionStrQU: "d21/tau",
    diffusionStrQV: "d22/tau",
    diffusionStrQQ: "D2",
    dimension: "1",
    domainScale: "30",
    dt: 0.0005,
    ...
    reactionStrU: "w",
    reactionStrV: "q",
    reactionStrW: "(u - a*u^3 + v - b - w)/tau",
    reactionStrQ: "(b - u - 3*a*v - q)/tau",
    spatialStep: "0.5",
    typeOfBrush: "vline",
    whatToDraw: "u",
    whatToPlot: "u",
  ...
  listOfPresets["cyclicCompetition"] = {
    ...
    boundaryConditionsW: "neumann",
    brushRadius: "10",
    clearValueU: "1/cosh(sqrt((x-L_x/2)^2+(y-L_y/2)^2))",
    clearValueV: "1/cosh(sqrt((x-L_x/2)^2+(y-L_y/2)^2))",
    clearValueW: "1/cosh(sqrt((x-L_x/2)^2+(y-L_y/2)^2))",
    colourmap: "ice",
    diffusionStrUU: "2",
    diffusionStrVV: "0.5",
    diffusionStrWW: "0.5",
