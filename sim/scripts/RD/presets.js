  ...
  switch (id) {
    ...
    case "GiererMeinhardtStripeICs":
      options = {
        ...
        domainScale: 100,
        dt: 0.0005,
        kineticParams: "a=0.5;b=1;c=6.1;n=6;",
        maxColourValue: 24,
        minColourValue: 0.6,
        numTimestepsPerFrame: 200,
    ...
    case "GiererMeinhardtStripes":
      options = {
        ...
        domainScale: 200,
        dt: 0.0005,
        kineticParams: "a=0.5;b=1;c=6.1;K=0.003;",
        maxColourValue: 9,
        minColourValue: 1.5,
        numTimestepsPerFrame: 200,
    ...
    case "FitzHugh-Nagumo-Hopf":
      options = {
        ...
        dt: 0.001,
        fixRandSeed: true,
        kineticParams: "m=4;e_v=0.2;a_v=.01;a_z=-0.1;",
        minColourValue: -1,
        numSpecies: "2",
    ...
    case "FitzHugh-Nagumo-3":
      options = {
        ...
        dt: 0.001,
        fixRandSeed: true,
        kineticParams: "m=4;e_v=0.2;e_w=1;a_v=.065;a_w=0.5;a_z=-0.1;",
        minColourValue: -1,
        numSpecies: "3",
    ...
    case "inhomogHeatEquation":
      options = {
        ...
        domainScale: 100,
        dt: 0.004,
        kineticParams: "n=4;m=4;",
        minColourValue: -1,
        numSpecies: 1,
        preset: "inhomogHeatEquation",
        reactionStrU: "cos(n*pi*x/L_x)*cos(m*pi*y/L_y)*pi^2*((n/L_x)^2 + (m/L_y)^2)",
        reactionStrV: "0",
        reactionStrW: "0",
        spatialStep: 0.5,
        suppressTryClickingPopup: true,
    ...
    case "inhomogDiffusionHeatEquation":
      options = {
        ...
        brushRadius: 5,
        clearValueU: "1",
        diffusionStrUU: "D*(1+E*cos(n*pi*sqrt((x-L_x/2)^2+(y-L_y/2)^2)/sqrt(L_x*L_y)))",
        diffusionStrVV: "0",
        diffusionStrWW: "0",
        domainScale: 100,
        dt: 0.004,
    ...
    case "swiftHohenberg":
      options = {
        ...
        diffusionStrWW: "0",
        dt: 0.0005,
        kineticParams: "r=0.1;D=1;a=1;b=1;c=-1",
