...
presets["RockPaperScissorsLizardSpock"] = {
  ...
  diffusionStr_4_4: "D",
  diffusionStr_5_5: "D",
  expressions: "rho =a+b+c+d+e;a0=1/(5+2*sigma);",
  guiUpdatePeriod: 3,
  initCond_1: "a0*(1+0.1*RANDN)^9",
  initCond_2: "a0",
  initCond_3: "a0",
  initCond_4: "a0",
  initCond_5: "a0",
  kineticParams: "sigma = 3;s=0.8;r = s+sigma;D=0.3;",
  numSpecies: 5,
  parent: "cyclicCompetitionWave",
  preset: "RockPaperScissorsLizardSpock",
  reactionStr_1: "a*(1-rho-r*(b+d)+s*(c+e))",
  reactionStr_2: "b*(1-rho-r*(c+e)+s*(d+a))",
  reactionStr_3: "c*(1-rho-r*(d+a)+s*(e+b))",
  reactionStr_4: "d*(1-rho-r*(e+b)+s*(a+c))",
  reactionStr_5: "e*(1-rho-r*(a+c)+s*(b+d))",
...
presets["RWBIAD"] = {
  ...
  contours: true,
  contourNum: 1,
  diffusionStr_1_1: "(speed_r*(1+H(t-T)*speed_rh)*(1+r))*phi",
  diffusionStr_2_2: "(speed_h*(1+h))*phi",
  diffusionStr_3_3: "0",
  domainScale: "200",
  dt: 0.01,
  expressions: "phi = max(1-r-h,0);",
  guiUpdatePeriod: 3,
  ...
  preset: "RWBIAD",
  renderSize: 1024,
  reactionStr_1: "max(r,0)*phi",
  reactionStr_2: "max(h,0)*phi+(1/cosh(t-T_h)^2)*Bump(x_h,y_h,L_x*R)",
  reactionStr_3: "0",
...
presets["inhomogWaveEquation"] = {
  ...
  crossDiffusion: true,
  diffusionStr_1_1: "C*D",
  diffusionStr_2_1: "D*chi",
  diffusionStr_2_2: "0",
  diffusionStr_3_3: "0",
  domainScale: "100",
  dt: 0.001,
  expressions: "chi = (1+E*sin(pi*m*x/L_x))*(1+E*sin(n*pi*y/L_y));",
