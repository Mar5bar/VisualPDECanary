  ...
  switch (id) {
    case "Test":
      options = {
        ...
        boundaryConditionsU: "mixed",
        boundaryConditionsV: "mixed",
        mixedStrU: "Left: Dirichlet = 1; Right: Neumann = 0; Top: Robin = 0.2; Bottom: Dirichlet = 0",
        mixedStrV: "Left: Dirichlet = 1; Right: Neumann = 0; Top: Robin = 0.2; Bottom: Dirichlet = 0",
        preset: "Test",
      };
      break;
