...
export function getPreset(id) {
  ...
  switch (id) {
	...
	"dt": 0.01,
	"flippedColourmap": true,
	"kineticParams": "X = 40*sqrt(2)* (sin(theta))^3;theta = 5.86510 in [0, 6.2831];Y = 40*(-(cos(theta))^3 - (cos(theta))^2 + 2*cos(theta));k = 0.01",
	"numSpecies": 1,
	"preset": "heatHeart",
	"reactionStrU": "exp(-0.3*((x-L_x/2 - 40*sqrt(2)* (sin(t*k))^3)^2 + (y-L_y*0.7 - 40*(-(cos(t*k))^3 - (cos(t*k))^2 + 2*cos(t*k)))^2))",
	"reactionStrV": "0",
	"reactionStrW": "0",
	"spatialStep": "1.5",
	"speciesNames": "T",
