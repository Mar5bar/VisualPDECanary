...
You might notice that, as time goes by, the yellow becomes less bright and the blue becomes less dark. This is because the waves are losing energy all the time (due to friction and the slight stickiness of the water), leading to a smoother surface that will eventually become still again.
