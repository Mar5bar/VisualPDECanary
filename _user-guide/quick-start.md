...
* You can change the number of unknowns by choosing <span class='click_sequence'>**Parameters and variables** → **Variables** → **Num. variables**</span>
...
* In systems of multiple unknowns, you can choose between a differential or algebraic equation for some of the variables (e.g. '$\partial w/\partial t=$' or '$w=$') by setting <span class='click_sequence'>**Parameters and variables** → **Variables** → **Num. algebraic**</span>
