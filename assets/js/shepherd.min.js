...
H(b);d&&d.d()}}}function gc(a,b,c){let d,{step:e}=b;a.$$set=f=>{"step"in f&&c(0,e=f.step)};a.$$.update=()=>{a.$$.dirty&1&&c(1,d=e.options.buttons)};return[e,d]}function hc(a){let b,c,d,e,f;return{c(){b=document.createElement("button");c=document.createElement("span");c.innerHTML='<i class="fa-regular fa-circle-xmark"></i>';z(c,"aria-hidden","true");z(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");z(b,"class","shepherd-cancel-icon");z(b,"type","button")},m(g,h){g.insertBefore(b,h||null);b.appendChild(c);e||(f=Ca(b,"click",a[1]),
